...
int start(const Config &cfg, int retry_limit) {
  ...
  // ‚î¢„‚î¢„ Pre-flight checks ‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„
  if (cfg.vpn_engine == "native") {
    ...
    // Homebrew found ‚Ä?attempt to install openconnect
  ...
  // Prefer helper daemon even when running as root ‚Ä?it manages session state
  ...
  // ‚î¢„‚î¢„ Decrypt / prompt password ‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„
...
int start_with_password(const Config &cfg, const std::string &plaintext_password,
  ...
  if (cfg.vpn_engine == "native") {
    // ‚î¢„‚î¢„ D1: Native engine supervisor bypass ‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„
    //
    ...
    // TunnelController is not available ‚Ä?fall through to the legacy
  ...
  // ‚î¢„‚î¢„ Generate tunnel script ‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„
...
// Clean up routes before killing openconnect ‚Ä?while the tunnel
...
int stop() {
  ...
  if (helper::is_available()) {
    ...
    if (ok) return 0;
    // Helper said not running ‚Ä?check for orphaned processes before giving up
  }
  ...
  clear_runtime_state();
  std::cout << std::endl;
  utils::print_success("VPN connection stopped successfully! üéâ");
...
int status() {
  ...
  if (snapshot.running) {
    std::cout << utils::GREEN << utils::BOLD << "  ‚ó?VPN is RUNNING"
              << utils::RESET << std::endl;
    std::cout << std::endl;
    if (snapshot.pid > 0) {
    ...
    std::cout << utils::RED << utils::BOLD << "  ‚ó?VPN is NOT RUNNING"
              << utils::RESET << std::endl;
    clear_runtime_state();
  }

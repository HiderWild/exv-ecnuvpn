...
以下 9 条路由为华东师范大学校园网 IP 段，连接 VPN 后**仅这些网段的流量走 VPN 隧道**：
...
| `59.78.176.0/20` | 校园网段 |
| `59.78.199.0/21` | 校园网段 |
| `58.198.176.128/25` | 校园网段 |
| `219.228.60.69` | 校园单 IP |
| `59.78.189.128/25` | 校园网段 |
| `219.228.63.0/21` | 校园网段 |
| `202.120.80.0/20` | 校园网段 |
| `222.66.117.0/24` | 校园网段 |

> 实际路由以 `~/.ecnuvpn/config.json` 中 `routes` 字段为准，可通过 `exv config routes list` 查看。
